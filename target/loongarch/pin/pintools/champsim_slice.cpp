...
#define JUMP_LENGTH 66
#define SLICE_LENGTH 100000000
...
void reach_icount_end(){
    ...
    if(ibar_end){
        ...
        icount_begin = icount_end + JUMP_LENGTH;
        icount_end = icount_end + SLICE_LENGTH;
        fclose(trace_file);
...
{
    icount_begin = JUMP_LENGTH;
    icount_end = SLICE_LENGTH;
